    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src="{{asset('resources/views/images/logo.png')}}" width="110%" alt="Logo"></a>
                <a class="navbar-brand hidden" href="./"><img src="{{asset('resources/views/images/logo2.png')}}" width="100%" alt="Logo"></a>
            </div>
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <h3 class="menu-title">Product & Order</h3>
                    <li>
                        <a id="order-list-btn" href="{{url('/order/list')}}"> <i class="menu-icon fa fa-map-o"></i>Order List</a>
                        <a id="product-list-btn" href="{{url('/product/list')}}"> <i class="menu-icon fa fa-map-o"></i>Product List</a>
                        <a href="{{url('/product/new')}}"> <i class="menu-icon fa fa-glass"></i>New Product</a>
                        <!-- <a href="{{url('/partial-list/All')}}"> <i class="menu-icon fa fa-check-square-o"></i>Partial List</a> -->
                    </li>
                    <h3 class="menu-title">Setting</h3>
                     <li>
                        <a id="logout-btn" href="{{url('/logout')}}"><i class="menu-icon fa fa-puzzle-piece"></i>Logout</a>
                     </li>
                    <!-- <h3 class="menu-title">Price Comparing</h3>
                        <li>
                            <a href="{{url('/price-comparing/above')}}"><i class="menu-icon fa fa-paper-plane"></i>Pricing Above Competitors</a>
                            <a href="{{url('/price-comparing/below')}}"><i class="menu-icon fa fa-exclamation-triangle"></i>Pricing Below Competitors</a>
                        </li>
                    <h3 class="menu-title">General Settings</h3>
                        <li>
                            <a href="{{url('/settings/delivery-fee')}}"><i class="menu-icon fa fa-puzzle-piece"></i>Delivery Fee Settings</a>
                            <a href="{{url('/settings/update-password')}}"><i class="menu-icon fa fa-id-badge"></i>Update Password</a>
                        </li> -->
                </ul>
            </div>
        </nav>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <lable>Hi, {{Session::get('manager')[0]['name']}} !</lable>
                        </a>
                    </div>
                </div>
            </div>
